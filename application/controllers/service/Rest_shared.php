...
class Rest_shared extends REST_Controller {
    ...
    function deleteEntry_get(){
        ...
        $status = $this->get('status');
        if($table == "staff"){
            $this->General_Model->delete_user($selected_id);
        }
    ...
    function get_amount_types_drop_down_get(){
        $data['data'] = $this->common_functions->get_amount_types();
        if (!$data) {
            echo json_encode(['message' => 'error','viewMessage' => 'Error Occured']);
            return;
        }
	...
	function get_bank_transaction_filter_types_drop_down_get(){
		$data['data'] = $this->common_functions->get_bank_transaction_all_types();
        if (!$data) {
            echo json_encode(['message' => 'error','viewMessage' => 'Error Occured']);
            return;
        }
    ...
    function get_type_drop_down_get(){
        $data['data'] = $this->common_functions->get_book_types();
        if (!$data) {
            echo json_encode(['message' => 'error','viewMessage' => 'Error Occured']);
            return;
        }
    ...
    function get_mode_of_payment_get(){
        $data['data'] = $this->common_functions->get_mode_of_payment();
        if (!$data) {
            echo json_encode(['message' => 'error','viewMessage' => 'Error Occured']);
            return;
        }
    ...
    function get_hall_types_dropdown_get(){
        $data['data'] = $this->common_functions->get_hall_types();
        if (!$data) {
            echo json_encode(['message' => 'error','viewMessage' => 'Error Occured']);
            return;
        }
    ...
    function get_counter_prasadam_avialability_drop_down_get(){
        $data['data'] = $this->common_functions->get_counter_prasadam_avialability_types();
        if (!$data) {
            echo json_encode(['message' => 'error','viewMessage' => 'Error Occured']);
            return;
        }
	...
	function get_zero_fd_accounts_drop_down_get(){
		$data['data'] = $this->common_functions->get_zero_fd_accounts($this->templeId);
        if (!$data) {
            echo json_encode(['message' => 'error','viewMessage' => 'Error Occured']);
            return;
        }
    ...
    function get_zero_sb_accounts_drop_down_get(){
        $data['data'] = $this->common_functions->get_zero_sb_accounts($this->templeId);
        if (!$data) {
            echo json_encode(['message' => 'error','viewMessage' => 'Error Occured']);
            return;
        }
