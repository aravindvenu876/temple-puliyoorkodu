...
class Stock extends CI_Controller {
    ...
    function stock_issue1(){
        $this->data['subMenuId'] = '119';
        $this->data['subMenuLabel'] = $this->common_functions->get_submenu_label($this->data['subMenuId']);
        $this->load->view('includes/header',$this->data);
        $this->load->view('stock/stock_issue',$this->data);
        $this->load->view('stock/stock_issue_script',$this->data);
        $this->load->view('includes/footer');
    }
