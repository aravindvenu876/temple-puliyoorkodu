...
class Daily_list extends CI_Controller {
    ...
    public function pooja_list() {
        ...
        $this->load->view('daily_list/pooja_list',$this->data);
        $this->load->view('daily_list/pooja_list_script',$this->data);
        $this->load->view('includes/footer');
    }

    public function nivedya_list(){
        $this->load->view('includes/header',$this->data);
        $this->load->view('daily_list/nivedya_list',$this->data);
        $this->load->view('daily_list/nivedya_list_script',$this->data);
        $this->load->view('includes/footer');
    }
