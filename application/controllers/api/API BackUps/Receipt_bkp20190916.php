                ...
                if(!empty($normalPoojaCheck)){
                    ...
                    if($this->api_model->cancel_individual_receipt($actualReceiptid,$this->requestData)){
                        if($receiptDetail['accounting_status'] == 1){
							...
							foreach($receiptPoojaDetails as $poojaVal){
								...
								if($receiptDetail['pay_type'] == "Cheque"){
									$accountEntryMain['sub_type1'] = "Bank";
								}else if($receiptDetail['pay_type'] == "DD"){
									$accountEntryMain['sub_type1'] = "Bank";
								}else if($receiptDetail['pay_type'] == "MO"){
									$accountEntryMain['sub_type1'] = "Cash";
								}else if($receiptDetail['pay_type'] == "Card"){
									$accountEntryMain['sub_type1'] = "Bank";
								}else{
									$accountEntryMain['sub_type1'] = "Cash";
								}
								$accountEntryMain['sub_type2'] = "";
								$accountEntryMain['head'] = $poojaVal->pooja_master_id;
								$accountEntryMain['table'] = "pooja_master";
								$accountEntryMain['date'] = date('Y-m-d');
								$accountEntryMain['voucher_no'] = $receiptDetail['receipt_no'];
								$accountEntryMain['amount'] = $receiptDetail-['receipt_amount'];
