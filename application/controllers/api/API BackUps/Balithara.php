...
class Balithara extends REST_Controller {
    ...
    function balithara_payment_post(){
        // if($this->api_model->check_if_early_balithara_payment($this->requestData->detail_main_id,$this->requestData->detail_id)){
        ...
        // }else{
        //     $this->responseData['status'] = FALSE;
        //     $this->responseData['message'] = "Please pay the earlier installment first";
        // }
        $this->response($this->responseData);
    }
