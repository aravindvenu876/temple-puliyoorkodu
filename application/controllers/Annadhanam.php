...
class Annadhanam extends CI_Controller {
    ...
    public function annadhanam() {
        $this->load->view('includes/header',$this->data);
        $this->load->view('annadhanam/annadhanam',$this->data);
        $this->load->view('annadhanam/annadhanam_script',$this->data);
