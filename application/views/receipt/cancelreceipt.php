                            ...
                            <div class="tab-content">
                                <div class="tab-pane active">
                                    ...
                                    <form data-validate="parsley" action="" method="post" class="add-edit">
                                                    ...
                                                    <h3 id="form_title_h2"> <?php echo $this->lang->line('reason'); ?></h3><hr class="hrCustom">
                                    ...
                                    <h3><?php echo $this->lang->line('cancelled_receipts_details'); ?></h3>
                                    <hr class="hrCustom">
                                    <div class="row">
                                        ...
                                        <div class="table-responsive table_div">
                                            <table class="table list-data-table table-bordered scrolling table-striped table-sm" id="receipt" table="receipt" action_url="<?php echo base_url() ?>service/Receipt_data/cancel_receipt_details">
                                                <thead>
