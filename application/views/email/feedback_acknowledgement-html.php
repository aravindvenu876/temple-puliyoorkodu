                    ...
                    <table width="80%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td align="left" width="95%" style="font: 13px/18px Arial, Helvetica, sans-serif;">
                                <h2 style="font: normal 20px/23px Arial, Helvetica, sans-serif; margin: 0; padding: 0 0 18px; color: black;">Feedback Acknowledgement from IICT</h2><br />
                                <p><?php if($type=='admin') { echo $content_admin;} else { echo $content_user; } ?></p>
