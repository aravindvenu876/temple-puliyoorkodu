                            ...
                            <div class="tab-content">
                                <div class="tab-pane active">
                                        ...
                                        <form data-validate="parsley" action="" method="post" class="add-edit">
											...
											<div class="row">
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    ...
                                                    <div class="form-group">
                                                        <textarea name="description" id="description" class="form-control" placeholder="<?php echo $this->lang->line('description'); ?>"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="bg_form ">
                                                <div class="row" id="dynamic_asset_register">
                                                    ...
                                                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                                                        ...
                                                        <div class="form-group">
                                                            <input type="number" min="0" name="cost_1" id="cost_1" class="form-control parsley-validated rate" data-required="true" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                                    ...
                                    <div class="dtl_tbl show_form_add"  style="min-height: auto;" >
                                                ...
                                                <h3><?php echo $this->lang->line('stock_registration'); ?></h3><hr class="hrCustom">
                                        ...
                                        <div class="table-responsive table_div">
                                            <table class="table list-data-table table-bordered scrolling table-striped table-sm" id="asset_register" table="asset_register" action_url="<?php echo base_url() ?>service/Asset_register_data/assets_registration_details">
                                                <thead>
