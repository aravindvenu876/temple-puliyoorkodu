...
<script  type="text/javascript">
    ...
    var aoColumnDefs = [
        {
            "aTargets": [2], "mData": 3, "mRender": function (data, type, row) {
                if (data == 1)
            ...
            "aTargets": [3], "mData": 3, "mRender": function (data, type, row) {
                ...
                return "<a style='cursor: pointer;' data-toggle='tooltip' class='edit_btn_datatable' data-placement='right' data-original-title = '<?php echo $this->lang->line('edit_data'); ?>'>"+
                        ...
                        "<i class='fa fa-eye' aria-hidden='true'></i></a>"+chert;
            }
        }
    ];
    ...
    function detail_edit(data) { 
        ...
        $('#asset_category_eng').val(data.category_eng);
        $('#asset_category_alt').val(data.category_alt);
