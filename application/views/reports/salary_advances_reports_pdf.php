...
<html lang="en">
   <head>
      ...
      <title><?php echo $this->lang->line('salary_advance'); ?></title>
      <style>
         html,
         body,
         div,
      ...
      <div style="width: 100%; margin: auto;padding: 10px;border: 1px solid #ccc;background: #fff;">
		<div style="width:100%; text-align: center;">
			  ...
			  <p
                  ...
                  <?php 
                     if($salaryMonth == ""){
                        ...
                        echo date('F',strtotime("01-".$salaryMonth."-1970")).",";
							}
							echo ",";
							if($salaryYear == ""){
                        echo date('Y');
         ...
         <table style="width: 100%;margin: 20px 0px;">
            <tr style="background: #F1F1F1;padding: 10px;font-size: 10px;color: #26272F;text-align: left;font-family: 'Montserrat';font-weight: bold;">
               ...
               <td style="font-family: 'Montserrat', meera;font-weight: bold;font-size: 9px;color: #26272F;text-align: left;padding: 10px;font-size:14px;"><?php echo $this->lang->line('type'); ?></td>
               ...
               <td style="font-family: 'Montserrat', meera;font-weight: bold;font-size: 9px;color: #26272F;text-align: left;padding: 10px;font-size:14px;"><?php echo $this->lang->line('payslip_id'); ?></td> 
               <td style="font-family: 'Montserrat', meera;font-weight: bold;font-size: 9px;color: #26272F;text-align: left;padding: 10px;font-size:14px;"><?php echo $this->lang->line('created_on'); ?></td> 
        ...
        $i++;
         ?>
               ...
               <td style="font-family: 'Montserrat', meera;font-weight: 500;font-size: 9px;color: #26272F;text-align: left;padding: 10px;font-size:12px;">
               <?php echo $row->description; ?>
               </td>
               <td style="font-family: 'Montserrat', sans-serif;font-weight: 500;font-size: 9px;color: #26272F;text-align: left;padding: 10px;font-size:12px;">
               <?php echo $row->processed_salary_id; ?>
               </td>
               <td style="font-family: 'Montserrat', sans-serif;font-weight: 500;font-size: 9px;color: #26272F;text-align: left;padding: 10px;font-size:12px;">
