   ...
   <body style="background: #fafafa;width:100%;">
      ...
      <div style="width:100%; text-align: center;">
         ...
         style="font-family: 'Montserrat', meera;font-weight: bold;font-size: 16px;color: #26272F;letter-spacing: 0.46px;line-height: 18px;text-align: center;margin: 30px 0px 0px;text-transform: uppercase;display: block;">
            <?php echo $label4['collection_reports']; ?>
         </p>
         ...
         <tr style="background: #F1F1F1;padding: 10px;font-size: 10px;color: #26272F;text-align: left;font-family: 'Montserrat';font-weight: bold;">
               ...
               <td style="font-family: 'Montserrat', meera;font-weight: bold;font-size: 9px;color: #26272F;text-align: left;padding: 10px;font-size:14px;"><?php echo $this->lang->line('receipt_no'); ?></td>
               <td style="font-family: 'Montserrat', meera;font-weight: bold;font-size: 9px;color: #26272F;text-align: left;padding: 10px;font-size:14px;width:100px;"><?php echo $this->lang->line('pooja'); ?></td>
               ...
               <td style="font-family: 'Montserrat', meera;font-weight: bold;font-size: 9px;color: #26272F;text-align: left;padding: 10px;font-size:14px;"><?php echo $this->lang->line('amount'); ?>(₹)</td>
        ...
        foreach($report as $row){
            ...
            ?>
               ...
               <td style="font-family: 'Montserrat', meera;font-weight: 500;font-size: 9px;color: #26272F;text-align: left;padding: 10px;font-size:14px;">
               <?php echo $row->receipt_type; ?>
               </td>
               <td style="font-family: 'Montserrat', meera;font-weight: 500;font-size: 9px;color: #26272F;text-align: left;padding: 10px;font-size:14px;">
               <?php echo $row->receipt_status; ?>
               </td>
               <td style="font-family: 'Montserrat', meera;font-weight: 500;font-size: 9px;color: #26272F;text-align: left;padding: 10px;font-size:14px;">
               <?php echo date('d-m-Y',strtotime($row->receipt_date)); ?>
               </td>
               <td style="font-family: 'Montserrat', meera;font-weight: 500;font-size: 9px;color: #26272F;text-align: right;padding: 10px;font-size:14px;">
               <?php echo $row->receipt_amount; ?>
               </td>
               <td style="font-family: 'Montserrat', meera;font-weight: 500;font-size: 9px;color: #26272F;text-align: right;padding: 10px;font-size:14px;">
               <?php echo $row->name; ?>
               </td>
            ...
            <?php $total = $total + $row->receipt_amount; } ?>
            <tr style="border-bottom: 1px solid #9E9E9E;border-top: 1px solid #9E9E9E;padding: 10px;">
               <th colspan="5"
                  style="font-family: 'Montserrat',meera;font-weight: bold;font-size: 14px;color: #26272F;padding: 10px;font-size:14px;">
                  <?php echo $this->lang->line('total_amount'); ?>
               </th>
               <th 
                  style="font-family: 'Montserrat', sans-serif;font-weight: bold;font-size: 9px;color: #26272F;padding: 10px;text-align:right;font-size:12px;">
                 <?php echo number_format((float)$total, 2, '.', ''); ?>
               </th>
               <th colspan="6"
                  style="font-family: 'Montserrat', sans-serif;font-weight: bold;font-size: 9px;color: #26272F;padding: 10px;font-size:10px;">
