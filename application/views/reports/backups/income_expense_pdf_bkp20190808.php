...
<body style="background: #fafafa;margin: 15px 0;">
    <div style="width: 100%; margin: auto;padding: 20px;border: 1px solid #ccc;background: #fff;">
        ...
        <table style="width: 100%;margin: 20px 0px;">
            ...
            foreach($incomeReport as $row){
                ...
                foreach($receiptBookIncome as $key => $row1){
					...
					if($row->category == "Mattuvarumanam"){
        ...
        <table style="width: 100%;margin: 20px 0px;">
            ...
            <?php if($openingBalanceAmt != "No"){ ?>
                <?php $totalIncomeAmount = $totalIncomeAmount + $openingBalanceAmt; ?>
                <tr style="background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: bold;">
                    <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: 500;font-size:14px"><?php echo $this->lang->line('opening_balance'); ?>(₹)</td>
                    <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 12px;color: #26272F;text-align: right;font-family: 'Montserrat', sans-serif;font-weight: bold;"><?php echo $openingBalanceAmt; ?></td>
                </tr>
            <?php } ?>
            <tr style="background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: bold;">
