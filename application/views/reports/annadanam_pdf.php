   ...
   <body style="background: #fafafa;width:100%;">
      <div style="width: 100%; margin: auto;padding: 10px;border: 1px solid #ccc;background: #fff;">
		<div style="width:100%; text-align: center;">
         ...
         <?php echo $this->lang->line('annadanam_booking_report'); ?>
         </p>
         ...
         <table style="width: 100%;margin: 20px 0px;">
            <tr style="background: #F1F1F1;padding: 10px;font-size: 10px;color: #26272F;text-align: left;font-family: 'Montserrat';font-weight: bold;">
               <td style="font-family: 'Montserrat', meera;font-weight: bold;font-size: 14px;color: #26272F;text-align: left;padding: 16px;"><?php echo $this->lang->line('sl'); ?></td>
               <td style="font-family: 'Montserrat', meera;font-weight: bold;font-size: 14px;color: #26272F;text-align: left;padding: 16px;"><?php echo $this->lang->line('booked_on'); ?></td>
               <td style="font-family: 'Montserrat', meera;font-weight: bold;font-size: 14px;color: #26272F;text-align: left;padding: 16px;"><?php echo $this->lang->line('booked_date'); ?></td>
               <td style="font-family: 'Montserrat', meera;font-weight: bold;font-size: 14px;color: #26272F;text-align: left;padding: 16px;"><?php echo $this->lang->line('name'); ?></td>
               <td style="font-family: 'Montserrat', meera;font-weight: bold;font-size: 14px;color: #26272F;text-align: left;padding: 16px;"><?php echo $this->lang->line('phone'); ?></td>
               <td style="font-family: 'Montserrat', meera;font-weight: bold;font-size: 14px;color: #26272F;text-align: left;padding: 16px;"><?php echo $this->lang->line('advance_amount'); ?></td>
               <td style="font-family: 'Montserrat', meera;font-weight: bold;font-size: 14px;color: #26272F;text-align: left;padding: 16px;"><?php echo $this->lang->line('total_amount'); ?></td>
               <td style="font-family: 'Montserrat', meera;font-weight: bold;font-size: 14px;color: #26272F;text-align: left;padding: 16px;"><?php echo $this->lang->line('payment_status'); ?></td>
            </tr>
            <?php    
               $i=0;
               $total=0;
            ...
            ?>
               <tr>
                  <td style="font-family: 'Montserrat', sans-serif;font-weight: 500;font-size: 12px;color: #26272F;text-align: left;padding: 14px;">
                     <?php echo $i ?>
                  </td>
                  <td style="font-family: 'Montserrat', sans-serif;font-weight: 500;font-size: 12px;color: #26272F;text-align: left;padding: 14px;">
                     <?php echo date('d-m-Y',strtotime($row->booked_on)); ?> 
                  </td>
                  <td style="font-family: 'Montserrat', sans-serif;font-weight: 500;font-size: 12px;color: #26272F;text-align: left;padding: 14px;">
                     <?php echo date('d-m-Y',strtotime($row->booked_date)); ?> 
                  </td>
                  <td style="font-family: 'Montserrat',meera;font-weight: 500;font-size: 14px;color: #26272F;text-align: left;padding: 14px;">
                     <?php echo $row->name; ?>
                  </td>
                  <td style="font-family: 'Montserrat', sans-serif;font-weight: 500;font-size: 12px;color: #26272F;text-align: left;padding: 14px;">
                     <?php echo $row->phone; ?>
                  </td>
                  <td style="font-family: 'Montserrat', sans-serif;font-weight: 500;font-size: 12px;color: #26272F;text-align: right;padding: 14px;">
                     <?php echo $row->adavnce_paid; ?>
                  </td>
                  <td style="font-family: 'Montserrat', sans-serif;font-weight: 500;font-size: 12px;color: #26272F;text-align: right;padding: 14px;">
            ...
            <tr style="border-bottom: 1px solid #9E9E9E;border-top: 1px solid #9E9E9E;padding: 10px;">
               <td colspan="6"
                  style="font-family: 'Montserrat', meera;font-weight: bold;font-size: 16px;color: #26272F;text-align: right;padding: 10px;">
                  <?php echo $this->lang->line('total_amount'); ?>
               </td>
               <td
                  style="font-family: 'Montserrat', sans-serif;font-weight: bold;font-size: 12px;color: #26272F;text-align: right;padding: 10px;font-size:14px">
