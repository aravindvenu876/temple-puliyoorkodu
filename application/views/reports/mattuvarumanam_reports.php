                            ...
                            <div class="tab-content">
                                <div class="tab-pane active">
                                    <div class="dtl_tbl show_form_add"  style="min-height: auto;" >
                                                <h3><?php echo $this->lang->line('mattuvarumanam_report'); ?></h3>
												<hr class="hrCustom">
                                        <div class="row">   
                                        <div class="col-md-3 col-sm-6 col-12 calendar_iconless">
                                            ...
                                            <div class="col-md-3 col-sm-6 col-12">
                                                ...
                                                <div class="form-group">
                                                    <select name="from_sec" id="from_sec" class="form-control">
                                            ...
                                            <div class="col-md-3 col-sm-6 col-12">
                                                <span class="span_label"><?php echo $this->lang->line('mattuvarumanam_cat'); ?></span>
                                                <div class="form-group">
                                            ...
                                            <table class="table table-bordered scrolling table-striped table-sm">
                                                <thead>
                                                    <tr class="bg-warning text-white ">
                                                        ...
                                                        <th><?php echo $this->lang->line('mattuvarumanam_cat'); ?></th>
                                                        <th><?php echo $this->lang->line('name'); ?></th>
                                                        <th><?php echo $this->lang->line('phone'); ?></th>
                                                        <th><?php echo $this->lang->line('amount'); ?></th>
                                                        <th><?php echo $this->lang->line('from_sec'); ?></th>
                                                    </tr>
                                                </thead>
