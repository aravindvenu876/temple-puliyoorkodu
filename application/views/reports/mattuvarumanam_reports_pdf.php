...
<html lang="en">
  	<head>
		...
		<title>Mattuvarumanam Report</title>
		<style>
			html,
			body,
			div,
   	...
   	<body style="background: #fafafa;width:100%;">
		  ...
		  <div style="width:100%; text-align: center;">
			...
			<p style="font-family: 'Montserrat', meera;font-weight: bold;font-size: 16px;color: #26272F;letter-spacing: 0.46px;line-height: 18px;text-align: center;margin: 30px 0px 0px;text-transform: uppercase;display: block;">
				<?php echo $this->lang->line('mattuvarumanam_report'); ?>
			</p>
			...
			<table style="width: 100%;margin: 20px 0px;">
				<tr style="background: #F1F1F1;padding: 10px;font-size: 10px;color: #26272F;text-align: left;font-family: 'Montserrat';font-weight: bold;">
					...
					<td style="font-family: 'Montserrat', meera;font-weight: bold;font-size: 9px;color: #26272F;text-align: left;padding: 10px;font-size:14px"><?php echo $this->lang->line('mattuvarumanam_cat'); ?></td>
					...
					<td style="font-family: 'Montserrat', meera;font-weight: bold;font-size: 9px;color: #26272F;text-align: left;padding: 10px;font-size:14px"><?php echo $this->lang->line('from_sec'); ?></td>
				</tr>
				<?php    
						$i=0; 
						$total=0;
				...
				<tr>
					...
					<td style="font-family: 'Montserrat', meera;font-weight: 500;font-size: 9px;color: #26272F;text-align: left;padding: 10px;font-size:14px">
						<?php 
							if($row->from_section == '3'){
								echo $this->lang->line('mattuvarumanam')." - ".$this->lang->line('receipt_book');
							}else{
								echo $row->category;
							}
						?>
					...
					<td style="font-family: 'Montserrat', meera;font-weight: 500;font-size: 9px;color: #26272F;text-align: left;padding: 10px;font-size:14px">
						<?php 
							if($row->from_section == '1'){
								echo "Counter"; 
							}else if($row->from_section == '2'){
								echo "Admin"; 
							}else{
								echo "Receipt Book"; 
							}
				...
				<tr style="border-bottom: 1px solid #9E9E9E;border-top: 1px solid #9E9E9E;padding: 10px;">
					<td colspan="5" style="font-family: 'Montserrat', meera;font-weight: bold;font-size: 9px;color: #26272F;text-align: right;padding: 10px;font-size:12px">
