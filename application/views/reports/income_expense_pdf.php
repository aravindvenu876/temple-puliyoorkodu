...
<body style="background: #fafafa;margin: 15px 0;">
    ...
    <div style=" clear: both"></div>
        ...
        <table style="width: 100%;margin: 20px 0px;">
            ...
            <!-- <tr style="background: #F1F1F1;padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: bold;">
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: bold;font-size:14px;"><?php echo 'Opening '.$this->lang->line('Deposit_Balance').' - '.$from_date."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".number_format($balanceToDeposit, 2, '.', '');?></td>           
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 12px;color: #26272F;text-align: right;font-family: 'Montserrat', sans-serif;font-weight: bold;"></td>              
            </tr>
            <tr style="background: #F1F1F1;padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: bold;">
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: bold;font-size:14px;"><?php echo 'Closing '.$this->lang->line('Deposit_Balance').' - '.$to_date."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".number_format($balanceToDeposit, 2, '.', '');?></td>           
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 12px;color: #26272F;text-align: right;font-family: 'Montserrat', sans-serif;font-weight: bold;"></td>              
            </tr> -->
