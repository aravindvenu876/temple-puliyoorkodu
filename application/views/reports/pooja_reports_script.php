...
<script type="text/javascript">
   ...
   $('#from_date').datepicker({
    ...
    function get_reports(){
        ...
        // var user = $("#user").val();
        // var pooja = $("#pooja").val();
        $("#report_body").html('<tr><td colspan="5" style="text-align:center"><b>...Please Wait...</b></td></tr>');
        $.ajax({
            url: '<?php echo base_url() ?>service/Reports_data/get_pooja_report',
            type: 'POST',
            ...
            success: function (data) {
                ...
                if (data.report.length === 0) {
                    $(".btn_print_html").hide();
                    $(".pdf_payslip").hide();
                    reportData += '<tr><td colspan="5" style="text-align:center"><b><?php echo $this->lang->line('no_records_found'); ?></b></td></tr>';
                }else{
                    $(".btn_print_html").show();
                    $(".pdf_payslip").show();
                    var j = 0;
                    ...
                    reportData += "<tr><th colspan='4' style='text-align:right'><?php echo $this->lang->line('total_amount'); ?></th>";
    ...
    $(".btn_print_html").click(function(){
        ...
        var pooja = $("#pooja").val();
        $.ajax({
            url: '<?php echo base_url() ?>service/Reports_data/get_pooja_report_print',
            type: 'POST',
            data:{from_date:from_date,to_date:to_date,counter:counter,user:user,pooja:pooja},
            success: function (data) {
