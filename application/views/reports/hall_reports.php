                            ...
                            <div class="tab-content">
                                <div class="tab-pane active">
                                    <div class="dtl_tbl show_form_add"  style="min-height: auto;" >
                                                <h3><?php echo $this->lang->line('hall_booking_report'); ?></h3>
												<hr class="hrCustom">
                                        <div class="row">   
                                        <div class="col-md-3 col-sm-6 col-12 calendar_iconless">
                                            ...
                                            <div class="col-md-3 col-sm-6 col-12 calendar_iconless">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" name="to_date" id="to_date" class="form-control" value="<?php echo date("d-m-Y", strtotime("+1 day"))?>"/>
                                                </div>
                                            </div>                                       
                                            <div class="col-md-3 col-sm-6 col-12">
                                                <span class="span_label"><?php echo $this->lang->line('hall'); ?></span>
                                                <div class="form-group">
                                                    <select name="hall" id="hall" class="form-control"></select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
