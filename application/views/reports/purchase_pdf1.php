...
$html = "";
$html .= '<h1>Purchase Report From '.$from_date.' To '.$to_date.' </h1>';
...
$html .= '<th>Date</th>';
$html .= '<th>Purchase Bill Number</th>';
...
$html .= '<td>'.$row->purchase_bill_no.'</td>';
$html .= '<td>'.$row->supplier_name.'</td>';
$html .= '<td>'.$row->asset_name_eng.'</td>';
$html .= '<td>'.$row->type.'</td>';
$html .= '<td style="text-align:right">'.$row->total_rate.'</td>';
$html .= '<td>'.$row->quantity.'</td>';
$html .= '<td style="text-align:right">'.$row->net.'</td>';
$html .= '</tr>';
}
