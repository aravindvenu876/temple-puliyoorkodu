...
<html lang="en">
   ...
   <body style="background: #fafafa;width:100%;">
      ...
      <div style=" clear: both"></div>
         ...
         <?php echo $this->lang->line('avahanam_report'); ?>
         </p>
         ...
         <table style="width: 100%;margin: 20px 0px;">
            <tr style="background: #F1F1F1;padding: 10px;font-size: 10px;color: #26272F;text-align: left;font-family: 'Montserrat';font-weight: bold;">
               ...
               <td style="font-family: 'Montserrat',meera;font-weight: bold;font-size: 9px;color: #26272F;text-align: left;padding: 10px;font-size:14px;"><?php echo $this->lang->line('booked_date'); ?></td>
               <td style="font-family: 'Montserrat',meera;font-weight: bold;font-size: 9px;color: #26272F;text-align: right;padding: 10px;font-size:14px;"> <?php echo $this->lang->line('pooja'); ?> <?php echo $this->lang->line('date'); ?></td>
               ...
               <td style="font-family: 'Montserrat',meera;font-weight: bold;font-size: 9px;color: #26272F;text-align: left;padding: 10px;font-size:14px;"><?php echo $this->lang->line('advance_amount'); ?>
               </td>
               <td style="font-family: 'Montserrat',meera;font-weight: bold;font-size: 9px;color: #26272F;text-align: left;padding: 10px;font-size:14px;"><?php echo $this->lang->line('total_amount'); ?> paid</td> 
            </tr>
        ...
        if($row->status == "DRAFT"){
         ...
         ?>
               ...
               <td style="font-family: 'Montserrat', meera;font-weight: 500;font-size: 12px;color: #26272F;text-align: left;padding: 10px;font-size:15px;">
               <?php echo $row->name; ?>
               </td>
               <td style="font-family: 'Montserrat', sans-serif;font-weight: 500;font-size: 9px;color: #26272F;text-align: left;padding: 10px;font-size:12px;">
               <?php echo $row->phone; ?>
            ...
            <tr style="border-bottom: 1px solid #9E9E9E;border-top: 1px solid #9E9E9E;padding: 10px;">
               <td colspan="6"
                  style="font-family: 'Montserrat', sans-serif;font-weight: bold;font-size: 9px;color: #26272F;text-align: left;padding: 10px;font-size:12px;">
                  Total
               </td>
               <td
