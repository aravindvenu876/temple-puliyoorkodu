...
$headerString = "Asset Issue & Return report";
...
$html = "";
$html .= '<h1>Asset Issue & Return report From '.$from_date.' To '.$to_date.' </h1>';
...
$html .= '<th>Status</th>';
$html .= '<th style="width:60px">Quantity</th>';
$html .= '<th style="width:60px">Returned Quantity</th>';
$html .= '<th style="width:60px">Damaged Quantity</th>';
$html .= '</tr>';
$i=0;
$total=0;
...
$html .= '<td>'.$row->asset_eng.'</td>';
$html .= '<td>'.$row->asset_status.'</td>';
$html .= '<td style="width:60px">'.$row->quantity.'</td>';
if($row->returned_quantity!=null){
    $html .= '<td style="width:60px">'.$row->returned_quantity.'</td>';
}
else{
    $html .= "<td></td>";
}
if($row->scrapped_quantity!=null){
    $html .= '<td style="width:60px">'.$row->scrapped_quantity.'</td>';
}
else{
    $html .= "<td></td>";
}
