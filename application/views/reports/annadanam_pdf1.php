...
$headerString = "Annadanam Booking Report ";
...
$html = "";
$html .= '<h1>Annadanam Booking Report '.$from_date.' To '.$to_date.' </h1>';
...
$html .= '<td>'.date('d-m-Y',strtotime($row->booked_date)).'</td>';
$html .= '<td>'.$row->name.'</td>';
$html .= '<td>'.$row->phone.'</td>';
$html .= '<td style="text-align:right">'.$row->adavnce_paid.'</td>';
$html .= '<td style="text-align:right">'.$row->amount_paid.'</td>';
