...
$html = "";
$html .= '<h1>Balithara Report From '.$from_date.' To '.$to_date.' </h1>';
...
$html .= '<th>To Date</th>';
$html .= '<th>Balithara Id</th>';
$html .= '<th>Buyer name</th>';
$html .= '<th>Phone</th>';
$html .= '<th style="text-align:right">Amount(₹)</th>';
$html .= '<th style="text-align:right">Monthly Rent</th>';
$html .= '<th>Due Dates</th>';
...
$html .= '<td>'.date('d-m-Y',strtotime($row->start_date)).'</td>';
$html .= '<td>'.date('d-m-Y',strtotime($row->end_date)).'</td>';
$html .= '<td>'.$row->balithara_eng.'</td>';
$html .= '<td>'.$row->name.'</td>';
$html .= '<td>'.$row->phone.'</td>';
$html .= '<td style="text-align:right">'.$row->total_amount.'</td>';
$html .= '<td style="text-align:right">'.$row->monthly_rate.'</td>';
