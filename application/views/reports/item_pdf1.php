...
$headerString = "Prasadam Availability Reports";
...
$html = "";
$html .= '<h1>Prasadam Availability Reports</h1>';
...
$html .= '<td>'.$row->item_eng.'</td>';
$html .= '<td>'.$row->quantity_available.'</td>';
$html .= '<td>'.$row->unit_eng.'</td>';
$html .= '</tr>';
}
$html .= '</table>';
$html .= "<br>";
