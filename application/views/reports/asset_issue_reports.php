                            ...
                            <div class="tab-content">
                                <div class="tab-pane active">
                                    <div class="dtl_tbl show_form_add"  style="min-height: auto;" >
                                                <h3><?php echo $this->lang->line('asset_issue_&_return_report'); ?></h3>
												<hr class="hrCustom">
                                        <div class="row">   
                                        <div class="col-md-3 col-sm-6 col-12 calendar_iconless">
                                            ...
                                            <div class="col-md-3 col-sm-6 col-12">
                                                <span class="span_label"><?php echo $this->lang->line('asset'); ?></span>
                                                <div class="form-group">
                                                    <select name="asset" id="asset" class="form-control"></select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <table class="table table-bordered scrolling table-striped table-sm">
                                                <thead>
                                                    <tr class="bg-warning text-white ">
                                                        ...
                                                        <th><?php echo $this->lang->line('rented_Quantity'); ?></th>
                                                        <th><?php echo $this->lang->line('Returned_Quantity'); ?></th>
                                                        <th><?php echo $this->lang->line('damaged_quantity'); ?></th>
                                                    </tr>
                                                </thead>
