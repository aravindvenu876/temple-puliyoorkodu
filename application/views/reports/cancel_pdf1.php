...
$html = "";
$html .= '<h1>Cancel Report From '.$from_date.' To '.$to_date.' </h1>';
$html .= '<h5 style="width:100%;float:left;"><b>Counter:</b>'.$counter.'</h5>';
$html .= '<h5 style="width:100%;float:left;"><b>User:</b>'.$user.'</h5>';
$html .= '<table cellpadding="4" cellspacing="1" border="1" style="font-size: 10px;width:100%">';
...
$html .= '<th>Amount(₹)</th>';
$html .= '<th>User</th>';
$html .= '<th style="width:50px">Counter</th>';
$html .= '</tr>';
$i=0;
$total=0;
...
$html .= '<td>'.$row->name.'</td>';
$html .= '<td style="width:50px">'.$row->counter_no.'</td>';
$html .= '</tr>';
}
$html .='<tr>';
$html .='<th colspan="4" style="text-align:left;padding:5px;border-bottom:1px solid #dedede;border-right:1px solid #dedede;text-align:right">Total Amount</th>';
...
$html .='<th colspan="4" style="text-align:left;padding:5px;border-bottom:1px solid #dedede;"></th>';
$html .='</tr>';
$html .= '</table>';
$html .= "<br>";
