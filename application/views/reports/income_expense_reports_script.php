...
<script type="text/javascript">
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.accountReport.length === 0) {
                    ...
                    reportData3 += "<tr>";
                    reportData3 += "<td style='width:30px'></td>";
                    reportData3 += "<td><?php echo $this->lang->line('opening_balance') ?>-("+data.from_date+")</td>";
                    reportData3 += "<td style='text-align:left'></td>";
                    reportData3 += "<td style='text-align:right'>"+parseFloat(data.openingBalanceToDeposit).toFixed(2)+"</td>";
                    reportData3 += "</tr>";
                    reportData3 += "<tr>";
                    reportData3 += "<td style='width:30px'></td>";
                    reportData3 += "<td>Petty cash-("+data.from_date+")</td>";
                    reportData3 += "<td style='text-align:left'></td>";
                ...
                if (data.accountReport.length === 0) {
                    ...
                    reportData4 += "<tr>";
                    reportData4 += "<td style='width:30px'></td>";
                    reportData4 += "<td><?php echo $this->lang->line('closing_balance') ?>-("+data.to_date+")</td>";
                    reportData4 += "<td style='text-align:left'></td>";
                    reportData4 += "<td style='text-align:right'>"+parseFloat(data.closingBalanceToDeposit).toFixed(2)+"</td>";
                    reportData4 += "</tr>";
                    reportData4 += "<tr>";
                    reportData4 += "<td style='width:30px'></td>";
                    reportData4 += "<td>Petty cash-("+data.to_date+")</td>";
                    reportData4 += "<td></td>";
                ...
                // reportData6 += "<tr>";
                // reportData6 += "<td ><?php echo 'Opening '.$this->lang->line('Deposit_Balance');?>-("+data.from_date+")</td>";
                // reportData6 += "<td style='text-align:left ;font-family:bold''>"+parseFloat(data.openingBalanceToDeposit).toFixed(2)+"</td>";
                // reportData6 += "</tr>";
                // reportData6 += "<tr>";
                // reportData6 += "<td ><?php echo 'Closing '.$this->lang->line('Deposit_Balance');?>-("+data.to_date+")</td>";
                // reportData6 += "<td style='text-align:left ;font-family:bold''>"+parseFloat(data.closingBalanceToDeposit).toFixed(2)+"</td>";
                // reportData6 += "</tr>";
    ...
    $(".excel_report").click(function(){
        var from_date = $("#from_date").val();
        var to_date = $("#to_date").val();
        window.open('<?php echo base_url() ?>service/Reports_data/get_income_expense_excel?from_date='+from_date+'&to_date='+to_date, '_blank');       
    });
