    ...
    <div style="width: 100%; margin: auto;padding: 20px;border: 1px solid #ccc;background: #fff;">
        <div style="width:70%; float: left;">
            ...
            <div style="margin-left:45px;">
                <h1 style="font-family: 'Montserrat', meera;font-size: 16px;color: #26272F;letter-spacing: 0.41px;text-align: left;text-transform: uppercase;font-weight: bold;padding: 0px 10px;display: inline-block;margin-bottom: 3px;font-weight: bold;">
                    <b><?php echo $temple; ?></b>
                </h1>
                <p style="font-family: 'Montserrat', meera;font-size: 14px;color: #26272F;letter-spacing: 0.42px;line-height: 12px;font-weight: bold;padding: 0px 10px;margin-bottom: 3px;">
        ...
        <table style="width: 100%;margin: 20px 0px;">
            ...
            foreach($incomeReport as $row){
                ...
                <tr style="background: #FFFFFF;;padding: 10px;font-size: 10px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: 500;">
                    ...
                    <td style="padding: 10px;padding: 10px;font-size: 10px;color: #26272F;text-align: right;font-family: 'Montserrat', sans-serif;font-weight: 500;font-size:12px"><?php echo number_format($ttIncome, 2, '.', ''); ?></td>
                </tr>
            <?php } 
            $i++;
            ...
            <tr style="border-bottom: 1px solid #9E9E9E;border-top: 1px solid #9E9E9E;padding: 10px;">
                <td style="font-family: 'Montserrat', meera;font-weight: bold;font-size: 16px;color: #26272F;text-align: left;padding: 10px;">
                <?php echo $this->lang->line('total_amount'); ?>(₹)
                </td>
                <td style="font-family: 'Montserrat', sans-serif;font-weight: bold;font-size: 12px;color: #26272F;text-align: left;padding: 10px;">
                </td>
        ...
        <table style="width: 100%;margin: 20px 0px;">
            <?php  foreach($accountReport as $row){ ?>
                <tr style="background: #F1F1F1;padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: bold;">
                    <td style="padding: 10px;background: #F1F1F1;padding: 12px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: 500;font-size:14px"><?php echo $this->lang->line('Withdrawal').'('.$row->bank_eng.'=>Temple)'; ?></td>
            ...
            <?php } ?>
            <tr style="background: #F1F1F1;padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: bold;">
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: 500;"> <?php echo $this->lang->line('Withdrawal'); ?></td>
            ...
            <tr style="background: #F1F1F1;padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: bold;">
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: 500;"><?php echo $this->lang->line('Income_By_Receipts'); ?></td>
            ...
            <tr style="background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: bold;">
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: 500;"><?php echo $this->lang->line('total_amount'); ?>(₹)</td>
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: right;font-family: 'Montserrat', sans-serif;font-weight: 500;"><?php echo number_format(($totalIncomeAmount), 2, '.', ''); ?></td>
            </tr>
        </table>

        <table style="width: 100%;margin: 20px 0px;">
<<<<<<< HEAD
            <caption style="font-family: 'Montserrat', sans-serif;font-weight: bold;font-size: 12px;color: #212121;letter-spacing: 0.37px;text-align: center;margin-bottom: 15px;text-transform: uppercase">
                Opening Balance
            </caption>
            <tr style="background: #F1F1F1;padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: bold;">
...
=======
            <caption
                style="font-family: 'Montserrat', meera;font-weight: bold;font-size: 16px;color: #212121;letter-spacing: 0.37px;text-align: center;margin-bottom: 15px;text-transform: uppercase">
...
>>>>>>> 32dca1265a1e731b0e8345273956b10a60facbfe
            </tr>
            <?php  
                $i=0;
                $sum=0;
            ...
            <tr style="background: #FFFFFF;padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: 500;">
                ...
                <td style="padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: 500;"><?php echo $this->lang->line('petty_cash'); ?></td>
        ...
        <table style="width: 100%;margin: 20px 0px;">  
            ...
            <tr style="background: #F1F1F1;padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: bold;">
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: bold;font-weight: 500">SI</td>
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: bold;font-weight: 500">Bank</td>
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: bold;font-weight: 500">Account</td>
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: right;font-family: 'Montserrat', meera;font-weight: bold;font-weight: 500">Amount</td>
            </tr>
            <?php 
                $defaultBankId = 0;
                ...
                foreach($fdAccountsOpening as $row){
                    if($i != 0){
                        if($defaultBankId != $row->bank_id){ ?>
                            <tr style="background: #FFFFFF;;padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: 500;">
                                <th style="padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: 500;"></td>
                                <th style="padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: 500;font-size:14px">Total <?php echo $defaultBank; ?>FD</td>
                                <th style="padding: 10px;font-size: 12px;color: #26272F;text-align: right;font-family: 'Montserrat', sans-serif;font-weight: 500;"></td>
                                <th style="padding: 10px;font-size: 12px;color: #26272F;text-align: right;font-family: 'Montserrat', sans-serif;font-weight: 500;"><?php echo number_format($bankSum, 2, '.', ''); ?></td>
                            </tr> 
                        <?php
                        $bankSum = 0;
                        }
            ...
            <tr style="background: #FFFFFF;;padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: 500;">
                <th style="padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: 500;"></td>
                <th style="padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: 500;font-size:14px">Total FD</td>
                <th style="padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: 500;"></td>
                <th style="padding: 10px;font-size: 12px;color: #26272F;text-align: right;font-family: 'Montserrat', sans-serif;font-weight: 500;"><?php echo number_format($totalSum, 2, '.', ''); ?></td>
            </tr>
        </table>
...
<<<<<<< HEAD
            <tr style="background: #F1F1F1;padding: 10px;font-size: 10px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: bold;">
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: bold;">SI</td>
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: bold;">Item</td>
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: bold;">Cash(₹)</td>
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: bold;">Card(₹)</td>
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: bold;">MO(₹)</td>
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: bold;">Cheque(₹)</td>
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: bold;">DD(₹)</td>
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: bold;">Total(₹)</td>
=======
...
>>>>>>> 32dca1265a1e731b0e8345273956b10a60facbfe
            ...
            <tr style="border-bottom: 1px solid #9E9E9E;border-top: 1px solid #9E9E9E;padding: 10px;">
                ...
                <td style="font-family: 'Montserrat', sans-serif;font-weight: bold;font-size:12px;color: #26272F;text-align: left;padding: 10px;"></td>
                <td style="font-family: 'Montserrat', sans-serif;font-weight: bold;font-size: 12px;color: #26272F;text-align: right;padding: 10px;">
...
=======
            ...
            <tr
                ...
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: 500;font-size:14px"><?php echo  $this->lang->line('Deposit').'('.$row->bank_eng.'=>Temple)'; ?></td>
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 12px;color: #26272F;text-align: right;font-family: 'Montserrat', sans-serif;font-weight: 500;"><?php echo number_format($row->totalDeposit, 2, '.', ''); ?></td>
               
            </tr><?php } ?>
            <tr
                style="background: #F1F1F1;padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: bold;">
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: 500;"><?php echo  $this->lang->line('Deposit');?></td>
>>>>>>> 32dca1265a1e731b0e8345273956b10a60facbfe
...
<<<<<<< HEAD
            ...
            <tr style="background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: bold;">
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: 500;"><?php echo $this->lang->line('total_amount'); ?>(₹)</td>
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: right;font-family: 'Montserrat', sans-serif;font-weight: 500;"><?php echo number_format(($totalExpenseAmount), 2, '.', ''); ?></td>
            </tr>
        </table>
        <table style="width: 100%;margin: 20px 0px;">
            <caption style="font-family: 'Montserrat', sans-serif;font-weight: bold;font-size: 12px;color: #212121;letter-spacing: 0.37px;text-align: center;margin-bottom: 15px;text-transform: uppercase">
...
=======
            <tr
                style="background: #F1F1F1;padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: bold;">
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: 500;"><?php echo  $this->lang->line('Expense_Vouchers');?></td>
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 12px;color: #26272F;text-align: right;font-family: 'Montserrat', sans-serif;font-weight: 500;"><?php echo number_format($totalVoucherExpense, 2, '.', ''); ?></td>
               
            </tr>
            <tr
                style="background: #F1F1F1;padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: bold;">
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: 500;"><?php echo $this->lang->line('Deposit_Balance');?> - <?php echo $to_date;?></td>
        ...
        <table style="width: 100%;margin: 20px 0px;">
            <caption
                style="font-family: 'Montserrat', meera;font-weight: bold;font-size: 16px;color: #212121;letter-spacing: 0.37px;text-align: center;margin-bottom: 15px;text-transform: uppercase">
                <?php echo $this->lang->line('closing_balance'); ?></caption>
            <tr
                style="background: #F1F1F1;padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: bold;">
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: bold;font-weight: 500"><?php echo $this->lang->line('sl'); ?></td>
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: bold;font-weight: 500"><?php echo $this->lang->line('item'); ?></td>
...
>>>>>>> 32dca1265a1e731b0e8345273956b10a60facbfe
            ...
            <tr style="background: #FFFFFF;;padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: 500;">
                ...
                <td style="padding: 10px;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: 500;"><?php echo $this->lang->line('petty_cash'); ?></td>
        ...
        <table style="width: 100%;margin: 20px 0px;">  
            ...
            <tr style="background: #F1F1F1;padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: bold;">
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: bold;font-weight: 500">Sl</td>
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: bold;font-weight: 500">Bank</td>
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: bold;font-weight: 500">Account</td>
                <td style="padding: 10px;background: #F1F1F1;padding: 10px;font-size: 14px;color: #26272F;text-align: right;font-family: 'Montserrat', meera;font-weight: bold;font-weight: 500">Amount</td>
            </tr>
                ...
                foreach($fdAccountsClosing as $row){
                    if($i != 0){
                        if($defaultBankId != $row->bank_id){ ?>
                            <tr style="background: #FFFFFF;;padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: 500;">
                                <th style="padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: 500;"></td>
                                <th style="padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: 500;font-size:14px;font-weight: bold;">Total <?php echo $defaultBank; ?>FD</td>
                                <th style="padding: 10px;font-size: 12px;color: #26272F;text-align: right;font-family: 'Montserrat', sans-serif;font-weight: 500;"></td>
                                <th style="padding: 10px;font-size: 12px;color: #26272F;text-align: right;font-family: 'Montserrat', sans-serif;font-weight: 500;font-size:14px;font-weight: bold;"><?php echo number_format($bankSum, 2, '.', ''); ?></td>
                            </tr> 
                        <?php
                        $bankSum = 0;
                        }
            ...
            <tr style="background: #FFFFFF;;padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: 500;">
                <th style="padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: 500;"></td>
                <th style="padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', meera;font-weight: 500;font-size:14px;font-weight: bold;">Total FD</td>
                <th style="padding: 10px;font-size: 12px;color: #26272F;text-align: left;font-family: 'Montserrat', sans-serif;font-weight: 500;"></td>
                <th style="padding: 10px;font-size: 12px;color: #26272F;text-align: right;font-family: 'Montserrat', sans-serif;font-weight: 500;font-size:14px;font-weight: bold;"><?php echo number_format($totalSum, 2, '.', ''); ?></td>
            </tr>
        </table>
