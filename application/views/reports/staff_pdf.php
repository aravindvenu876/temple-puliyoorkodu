   ...
   <body style="background: #fafafa;width:100%;">
      <div style="width: 100%; margin: auto;padding: 10px;border: 1px solid #ccc;background: #fff;">
		<div style="width:100%; text-align: center;">
         ...
         <?php echo $this->lang->line('staff_details_reports'); ?>
         </p>
         ...
         <table style="width: 100%;margin: 20px 0px;">
            <tr style="background: #F1F1F1;padding: 10px;font-size: 10px;color: #26272F;text-align: left;font-family: 'Montserrat';font-weight: bold;">
               ...
               <td style="font-family: 'Montserrat', meera;width:130px;font-weight: bold;font-size: 14px;color: #26272F;text-align: left;padding: 10px;"><?php echo $this->lang->line('staff_id'); ?></td>
               ...
               <td style="font-family: 'Montserrat', meera;font-weight: bold;font-size: 14px;color: #26272F;text-align: left;padding: 10px;"><?php echo $this->lang->line('phone_no'); ?></td>
               <td style="font-family: 'Montserrat', meera;font-weight: bold;font-size: 14px;color: #26272F;text-align: left;padding: 10px;"><?php echo $this->lang->line('designation'); ?></td>
               <td style="font-family: 'Montserrat', meera;font-weight: bold;font-size: 14px;color: #26272F;text-align: left;padding: 10px;"><?php echo $this->lang->line('type'); ?></td>
            </tr>
         <?php    $i=0;
