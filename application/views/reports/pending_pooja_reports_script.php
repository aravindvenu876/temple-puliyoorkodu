...
<script type="text/javascript">
   var date = new Date();
    ...
    function get_reports(){
        ...
        $.ajax({
            url: '<?php echo base_url() ?>service/Reports_data/get_pending_pooja_report',
            type: 'POST',
    ...
    $(".btn_print_html").click(function(){
        ...
        var user = $("#user").val();
        $.ajax({
            url: '<?php echo base_url() ?>service/Reports_data/get_pending_pooja_report_print',
            type: 'POST',
            data:{from_date:from_date,to_date:to_date},
            success: function (data) {
    ...
    $(".pdf_report").click(function(){
        ...
        var counter = $("#counter").val();
        var user = $("#user").val();
        window.open('<?php echo base_url() ?>service/Reports_data/get_pending_pooja_report_pdf?from_date='+from_date+'&to_date='+to_date+'&counter='+counter+'&user='+user, '_blank');       
    });
</script>
