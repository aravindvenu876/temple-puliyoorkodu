                        ...
                        <div class="dtl_tbl show_form_add"  style="min-height: auto;" >
                           ...
                           <div class="row">
                              <div class="col-md-12 col-sm-12 col-12 ">
                                 ...
                                 <button class="excel_report btn btn-primary">EXCEL</button>
                                 <button class="btn btn-default btn_clear"><?php echo $this->lang->line('clear'); ?></button>
                              </div>
                           </div>
                           <div class="row">
                           <h3 style="padding:10px;text-align: center;"><?php echo $this->lang->line('income'); ?></h3>
                              ...
                              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                              <h3 style="padding-bottom:0;"><?php echo $this->lang->line('opening_balance'); ?></h3>
                                 <div class="table-responsive" style="margin-top:15px">
                                    <table class="table table-bordered scrolling table-striped table-sm">
                                       <thead>
                                          <tr class="bg-warning text-white text-center">
                              ...
                              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                 <h3 style="padding-bottom:0;"><?php echo 'FD '.$this->lang->line('opening_balance'); ?></h3>
                                 <div class="table-responsive" style="margin-top:15px">
                                    <table class="table table-bordered scrolling table-striped table-sm">
                                       <thead>
                                          <tr class="bg-warning text-white text-center">
                              ...
                              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                 <h3 style="padding-bottom:0;"><?php echo $this->lang->line('expense'); ?></h3>
                                 <div class="table-responsive" style="margin-top:15px">
                                    <table class="table table-bordered scrolling table-striped table-sm">
                                       <thead>
                                          <tr class="bg-warning text-white text-center">
                           ...
                           <div class="row">
                              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                 <h3 style="padding-bottom:0;"><?php echo 'FD '.$this->lang->line('closing_balance'); ?></h3>
                                 <div class="table-responsive" style="margin-top:15px">
                                    <table class="table table-bordered scrolling table-striped table-sm">
                                       <thead>
                                          <tr class="bg-warning text-white text-center">
