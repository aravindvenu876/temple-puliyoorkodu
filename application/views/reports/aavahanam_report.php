                            ...
                            <div class="tab-content">
                                <div class="tab-pane active">
                                    <div class="dtl_tbl show_form_add"  style="min-height: auto;" >
                                        <h3><?php echo $this->lang->line('avahanam_report'); ?></h3>
                                        <hr class="hrCustom">
                                        <div class="row">   
                                            ...
                                            <table class="table table-bordered scrolling table-striped table-sm">
                                                <thead>
                                                    <tr class="bg-warning text-white ">
                                                        <th>Sl#</th>
                                                        <th><?php echo $this->lang->line('booked_date'); ?></th>
                                                        <th><?php echo $this->lang->line('pooja'); ?> <?php echo $this->lang->line('date'); ?></th>
                                                        <th><?php echo $this->lang->line('name'); ?></th>
                                                        <th><?php echo $this->lang->line('phone'); ?></th>
                                                        <th><?php echo $this->lang->line('advance_amount'); ?></th>
                                                        <th><?php echo $this->lang->line('total_amount'); ?> Paid</th>
