...
// $pdf->AddPage();
// $pdf->Write(5, 'Payslip for January 2019');
...
List example:
<ol>
    <li><img src="'.$logoUrl.'" alt="test alt attribute" width="30" height="30" border="0" /> test image</li>
    <li><b>bold text</b></li>
...
<img src="'.$logoUrl.'" alt="test alt attribute" width="100" height="100" border="0" /><img src="'.$logoUrl.'" alt="test alt attribute" width="100" height="100" border="0" /><img src="'.$logoUrl.'" alt="test alt attribute" width="100" height="100" border="0" />
</div>';
...
<tr><td><img src="'.$logoUrl.'" border="0" height="41" width="41" /></td></tr>
<tr style="text-align:left;"><td><img src="'.$logoUrl.'" border="0" height="41" width="41" align="top" /></td></tr>
<tr style="text-align:center;"><td><img src="'.$logoUrl.'" border="0" height="41" width="41" align="middle" /></td></tr>
<tr style="text-align:right;"><td><img src="'.$logoUrl.'" border="0" height="41" width="41" align="bottom" /></td></tr>
<tr><td style="text-align:left;"><img src="'.$logoUrl.'" border="0" height="41" width="41" align="top" /></td></tr>
<tr><td style="text-align:center;"><img src="'.$logoUrl.'" border="0" height="41" width="41" align="middle" /></td></tr>
<tr><td style="text-align:right;"><img src="'.$logoUrl.'" border="0" height="41" width="41" align="bottom" /></td></tr>
</table>';
