...
<script type="text/javascript">
    ...
    $.ajax({
        url: '<?php echo base_url() ?>service/Rest_shared/get_receipt_book_type_drop_down',
        type: 'GET',
    ...
    function detail_view(data) {
        ...
        viewdata += "<tr>";
        viewdata += "<th><?php echo $this->lang->line('book_type'); ?></th>";
        viewdata += "<td>" + data.editData.book_type + "</td>";
        viewdata += "</tr>";
        if(data.editData.book_type == "Pooja" && data.editData.book_type == "Prasadam"){
            viewdata += "<tr>";
            viewdata += "<th>Item</th>";
    ...
    function get_item_drop_down(val){
        ...
        }else if($("#book_type").val() == "Prasadam"){
            $("#variableInputType").show();
            $.ajax({
