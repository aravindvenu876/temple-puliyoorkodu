                            ...
                            <div class="tab-content">
                                <div class="tab-pane active">
                                    <div class="dtl_tbl show_form_add"  style="min-height: auto;" >                              
                                        <h3><?php echo 'Daily '.$this->lang->line('pooja_reports'); ?></h3>
                                        <hr class="hrCustom">                                           
                                        <div class="row">
                                        ...
                                        <!-- </div>
                                        <div class="row"> -->
                                            <div class="col-md-5 col-sm-12 col-12 " style="text-align:right">
                                                <br>
                                            ...
                                            <table class="table table-bordered scrolling table-striped table-sm">
                                                <thead>
                                                    <tr class="bg-warning text-white text-center">
                                                        ...
                                                        <th style="text-align:left;"><?php echo $this->lang->line('star'); ?></th>
