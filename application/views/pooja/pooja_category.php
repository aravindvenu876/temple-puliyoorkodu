                                        ...
                                        <form data-validate="parsley" action="" method="post" class="add-edit">
                                            ...
                                            <div class="row ">
                                                <div class="col-md-12 col-sm-12 col-12 ">
                                                    <button class="btn btn-primary saveButton"><?php echo $this->lang->line('pooja_categories_save'); ?></button>
                                                    <a class="btn btn-default" id="cancelEdit"><?php echo $this->lang->line('pooja_categories_cancel'); ?></a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
