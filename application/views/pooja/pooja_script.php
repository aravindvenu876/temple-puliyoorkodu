...
<script  type="text/javascript">
    ...
    var aoColumnDefs = [
        {
            ...
            "aTargets": [9], "mData": 9, "mRender": function (data, type, row) {
                if (data == 1)
            ...
            "aTargets": [10], "mData": 0, "mRender": function (data, type, row) {
                var btn = "";
    ...
    function detail_edit(data) { 
        ...
        $('#category').val(data.pooja_category_id);
        $('#type').val(data.type);
        $('#daily_pooja').val(data.daily_pooja);
        $('#quantity_pooja').val(data.quantity_pooja);
        $('#rate').val(data.rate);
        $('#pooja_eng').val(data.pooja_name_eng);
        $('#pooja_alt').val(data.pooja_name_alt);
        $('#description_eng').val(data.pooja_description_eng);
        $('#description_alt').val(data.pooja_description_alt);
        $('#website_pooja').val(data.website_pooja);
    ...
    function detail_view(data){
        ...
        viewdata += "<td>"+data.pooja_name_eng+"</td>";
        viewdata += "</tr>";
        viewdata += "<tr>";
		viewdata += "<th><?php echo $this->lang->line('pooja_alternate'); ?></th>";
        viewdata += "<td>"+data.pooja_name_alt+"</td>";
        viewdata += "</tr>";
        viewdata += "<tr>";
        ...
        viewdata += "</tr>";
        viewdata += "<tr>";
		viewdata += "<th>Quantity Pooja</th>";
        if(data.quantity_pooja == '0'){
            viewdata += "<td>No</td>";
        }else{
            viewdata += "<td>Yes</td>";
        }
        ...
        viewdata += "</tr>";
        viewdata += "<tr>";
		viewdata += "<th>Website Pooja</th>";
        if(data.website_pooja == '0'){
            viewdata += "<td>No</td>";
        }else{
            viewdata += "<td>Yes</td>";
        }
