                            ...
                            <div class="tab-content">
                                <div class="tab-pane active">
                                    <div class="dtl_tbl show_form_add" style="min-height: auto;">
                                        <h3><?php echo $this->lang->line('cheques_received'); ?></h3>
										<hr class="hrCustom">
                                        <button type="button" class="btn btn-primary btn_active btn-sm pull-right" onclick="download_cashless_report('Cheque','Excel')">Download Cheque Report In Excel</button>
                                        <button type="button" class="btn btn-primary btn_active btn-sm pull-right" onclick="download_cashless_report('Cheque','Pdf')" style="margin-right: 5px;">Download Cheque Report In PDF</button>
                                        <div class="table-responsive table_div">
                                            <table class="table list-data-table table-bordered scrolling table-striped table-sm" id="cheque_management" table="cheque_management" action_url="<?php echo base_url() ?>service/Cheque_data/received_cheque_details">
                                                <thead>
                                                    <tr class="bg-warning text-white ">
                                                        ...
                                                        <th><?php echo $this->lang->line('cheque_action'); ?></th>
        ...
        <input type="hidden" name="cheque_id" id="cheque_id"/>
         <div class="modal-content">
            <div class="modal-header">
               <h4 class="modal-title" id="form_title_h2"><?php echo $this->lang->line('process_cheque'); ?></h4>
            ...
            <div class="modal-body">
                ...
                <div class="row ">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <span class="span_label "><?php echo $this->lang->line('processed_cheque_status'); ?></span>
            ...
            <div class="modal-footer">
               <button type="button" class="btn btn-success saveData1"><?php echo $this->lang->line('PROCESS_CHEQUE'); ?></button>
