...
<script type="text/javascript">
        ...
        },
        {
            ...
            "mRender": function(data, type, row) {
                if(data == "RECEIVED"){
                    ...
                    return "<a class='btn btn-warning btn-sm process_result btn_active'>BOUNCED-NEW PAYMENT</a>";
                }else{
    ...
    function detail_view(data) {
        var viewdata = "";
        viewdata += "<tr>";
        viewdata += "<th><?php echo $this->lang->line('cheque_no'); ?></th>";
        viewdata += "<td>" + data.data.cheque_no + "</td>";
        viewdata += "</tr>";
        viewdata += "<tr>";
        viewdata += "<th><?php echo $this->lang->line('cheque_date'); ?></th>";
        ...
        viewdata += "</tr>";
        viewdata += "<tr>";
        viewdata += "<th><?php echo $this->lang->line('cheque_amount'); ?></th>";
        ...
        viewdata += "</tr>";
        viewdata += "<tr>";
        viewdata += "<th><?php echo $this->lang->line('cheque_status'); ?></th>";
    ...
    $("table tbody").on("click", "a.process", function () {
        ...
        $("#chequeNo").html("Cheque No : " + rowData[1]);
        $("#chequeDate").html("Cheque Date : " + convert_date(rowData[4]));
        $("#chequeAmount").html("Amount : INR " + rowData[2]);
        if(rowData[7] == null){
