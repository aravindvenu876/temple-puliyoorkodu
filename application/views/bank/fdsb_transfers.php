                                ...
                                <div class="tab-pane active">
                                    <div class="add_dtl" style="display: none;">
                                        <form data-validate="parsley" action="" method="post" class="add-edit">
                                            <h3 id="form_title_h2"><?php echo $this->lang->line('add_fd_to_sb_transfer'); ?></h3>
											<hr class="hrCustom">
											<input type="hidden" id="data_grid" name="data_grid">
											<input type="hidden" id="selected_id" name="selected_id">
											<div class="row">
                                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12"> 
                                                    <span class="span_label ">FD <?php echo $this->lang->line('bank'); ?> <span class="asterisk">*</span></span>
                                                    <div class="form-group">
                                                        <select name="fd_bank" id="fd_bank" class="form-control parsley-validated" data-required="true"></select>
                                                    </div>
                                                </div>
                                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12"> 
                                                    <span class="span_label ">FD <?php echo $this->lang->line('account'); ?> <span class="asterisk">*</span></span>
                                                    <div class="form-group">
                                                        <select name="fd_account" id="fd_account" class="form-control parsley-validated" data-required="true"></select>
                                                    </div>
                                                </div>
                                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12"> 
                                                    <span class="span_label ">SB <?php echo $this->lang->line('bank'); ?> <span class="asterisk">*</span></span>
                                                    <div class="form-group">
                                                        <select name="sb_bank" id="sb_bank" class="form-control parsley-validated" data-required="true"></select>
                                                    </div>
                                                </div>
                                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12"> 
                                                    <span class="span_label "><?php echo $this->lang->line('sb_account'); ?> <span class="asterisk">*</span> </span>
                                                    <div class="form-group">
                                                        <select name="sb_account" id="sb_account" class="form-control parsley-validated" data-required="true"></select>
                                                    </div>
                                                </div>
                                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12"> 
                                                ...
                                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12"> 
                                                    <span class="span_label ">Current <?php echo $this->lang->line('amount'); ?> <span class="asterisk">*</span></span>
                                                    <div class="form-group">
                                                        <input type="number" min="0.0" readonly step="0.1" name="deposit_amount"  id="deposit_amount" class="form-control parsley-validated" data-required="true"/>
                                                    </div>
                                                </div>
                                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12"> 
                                    ...
                                    <div class="dtl_tbl show_form_add" style="min-height: auto;">
                                        ...
                                        <button type="button" class="btn btn-warning btn_active btn-sm pull-right plus_btn btnPosition"><?php echo $this->lang->line('add_fd_to_sb_transfer'); ?></button>
                                        <div class="table-responsive table_div">
                                            <table class="table list-data-table table-bordered scrolling table-striped table-sm" id="view_fd_to_sb" table="view_fd_to_sb" action_url="<?php echo base_url() ?>service/Bank_data/fd_to_sb_details">
                                                <thead>
                                                    <tr class="bg-warning text-white ">
                                                        ...
                                                        <!-- <th>Current <?php echo $this->lang->line('amount'); ?>(INR)</th> -->
