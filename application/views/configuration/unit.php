                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12"> <span class="span_label "><?php echo $this->lang->line('unit'); ?><span class="asterisk">*</span></span>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"   name="unit_alt" id="unit_alt" class="form-control parsley-validated" data-required="true" placeholder="<?php echo $this->lang->line('in_alternate'); ?>"> </div>
                                                    </div>
                                                </div>
